...
pipclassifier.load_state_dict(torch.load("./Trained-models/pipclassifier.pt"))
digitai.load_state_dict(torch.load('./Trained-models/digitai.pt'))
operatorsai.load_state_dict(torch.load('./Trained-models/operatorsai.pt'))
pipclassifier.eval()
digitai.eval()
operatorsai.eval()
